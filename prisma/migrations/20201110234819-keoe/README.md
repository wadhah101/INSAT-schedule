# Migration `20201110234819-keoe`

This migration has been generated by Wadhah mahrouk at 11/11/2020, 12:48:19 AM.
...
CREATE TABLE "new_SchoolTime" (
    ...
    FOREIGN KEY ("schoolPeriodId") REFERENCES "SchoolPeriod"("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
migration 20201110233930-kk..20201110234819-keoe
--- datamodel.dml
+++ datamodel.dml
@@ -2,9 +2,9 @@
...
+  start   SchoolPeriod @relation(fields: [startId], references: [id])
   startId Int
